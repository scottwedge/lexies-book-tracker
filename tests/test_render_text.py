...
@pytest.mark.parametrize('source_text, expected_html', [
    ('hello world', 'hello world'),
    ("isn't this nice?", "isn&#8217;t this nice?"),
    ("This is a URL: https://example.net", 'This is a URL: <a href="https://example.net">https://example.net</a>'),
    ("This is an HTTP URL: http://example.net", 'This is an HTTP URL: <a href="http://example.net">http://example.net</a>'),
