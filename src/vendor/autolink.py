"""
This is a vendored version of autolink.py, with a one-line change to fix
a bug with URLs that are wrapped in parentheses.

I've filed an issue upstream (https://github.com/Suor/autolink/issues/3) and
opened a pull request to merge this fix (https://github.com/Suor/autolink/pull/4).

Until the patch is merged and released, I'm vendoring a copy of the file with
a local fix.  If there's a new autolink release, remove this file, bump
the version installed by pip, and fix any imports that use this file.
